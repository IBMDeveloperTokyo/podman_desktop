# Podman Desktopを触ってみよう！

Podman Desktopを使って、コンテナの基本操作を学べます。</br>
※一部操作はCLIでの実施となります。</br>
最後に作成したコンテナイメージを自身のIBM CloudのコンテナレジストリーにPUSHします。

## 免責

本ハンズオンではIBM Cloudの無料枠を利用します。</br>
